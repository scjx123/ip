...
|v1.0|Student before start of semester|Wants to see the list of module available|Choose which modules to take|
|v1.0|Student before start of semester|Filter the list of module according to my course either by keyword, module code or even MC |Wants to see the desired modules |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk0NTQxODQ5MCwyNjE5OTYyOTYsLTM2Mj

...
![here](Images/Logo.PNG../UI.png)
 ...
 - It is a Java application intended for students to track their modules, mc, daily task, as well as assignments for the individUser Guide Duke project (Marvel-Themed) 
...
1. **Verify the set up**: After the importing is complete, locate the `src/main/java/seedu/duke/Domnusuke.java` file, right-click it, and choose `Run Domnusuke.main()`. If the setup is correct, you should see something like the below:
   ```

    > Task :compileJava UP-TO-DATE
 
   > Task :processResources UP-TO-DATNO-SOURCE
    > Task :classes UP-TO-DATE
    
 
   > Task :Domnusuke.main()
    	_________________________________________________________Hello from
    ____        _        
   |  _ \ _   _| | _____ 
   | | | | | | | |/ / _ \
   | |_| | |_| |   <  __/
...
During the chat, you may feel free the tasks due within 3 days: 
...
* This project uses Gradle for builo change your chatbot assistant anytime during the chat, by typing in the above names as mentioned. 
## Features
...
## Command Summary
 ...
 - **Exit**: bye
	 - eg. `bye`
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5MTUyMDcxNV19
-->